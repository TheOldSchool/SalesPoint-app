    ...
    <form @submit.prevent="do_shop">
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" id="id" v-model="shop.id" disabled>
        </div>
        <div class="form-group col-md-6">
          <label for="date">Fecha</label>
          <input type="text" class="form-control" id="date" v-model="shop.date" disabled>
        </div>
      </div>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          ...
          <div class="input-group mb-2">
            ...
            <input type="number" class="form-control" id="price" placeholder="350.00" v-model="shop.price">
          </div>
        </div>
      </div>
